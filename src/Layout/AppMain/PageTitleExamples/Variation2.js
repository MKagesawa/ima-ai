...
export default class TitleComponent2 extends Component {
  ...
  notify22 = () =>
    (this.toastId = toast("Data pulled from the Big Brother!!!", {
      transition: Slide,
      closeButton: true,
      autoClose: 5000,
    ...
    return (
      <Fragment>
        ...
        <UncontrolledTooltip placement="left" target={"Tooltip-123"}>
          Pull data from national central AI database
        </UncontrolledTooltip>
        <UncontrolledDropdown className="d-inline-block">
          ...
          <DropdownMenu right>
            <Nav vertical>
              ...
              <NavItem>
                <NavLink href="javascript:void(0);">
                  <i className="nav-link-icon lnr-cloud-sync"> </i>
                  <span>Big Brother Cloud Sync</span>
                  <div className="ml-auto badge badge-pill badge-danger">5</div>
                </NavLink>
              </NavItem>
              <NavItem>
                <NavLink href="javascript:void(0);">
                  <i className="nav-link-icon pe-7s-cloud-upload"></i>
                  <span>Control your data shared to the central AI</span>
                </NavLink>
              </NavItem>
              <NavItem>
