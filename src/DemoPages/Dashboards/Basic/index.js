        ...
        return (
          <Fragment>
            ...
            >
              <div>
                <PageTitle
                  heading="Welcome to the Natioinal Central Intelligence"
                  subheading="This is an overview of the Big Brother AI utilizing anonymous personal data natioin-wide"
                            ...
                            <div className="widget-chart-content">
                              <div className="widget-description mt-0 text-warning">
                                ...
                                <span className="text-muted opacity-8 pl-1">
                                  Overall National Power Increase
                                </span>
                              </div>
                            </div>
                                ...
                                <div className="widget-content">
                                  <div className="widget-content-outer">
                                    <div className="widget-content-wrapper">
                                      ...
                                      <div className="widget-content-right">
                                        <div className="text-muted opacity-6">
                                          Population with Undesirable Genetics
                                        </div>
                                      </div>
                                    </div>
                                    <div className="widget-progress-wrapper mt-1">
                      ...
                      <Col lg="6">
                        <div className="card mb-3 widget-chart">
                          <div className="widget-chart-content">
                            ...
                            <div className="widget-numbers">4.1%</div>
                            <div className="widget-subheading">Data Spread</div>
                            <div className="widget-description text-success">
                              <FontAwesomeIcon icon={faAngleUp} />
                              <span className="pl-1">15.5%</span>
                            </div>
                          </div>
                  ...
                  <Col md="12" lg="6">
                    <Row>
                      <Col md="6">
                        <div className="card mb-3 bg-arielle-smile widget-chart text-white card-border">
                          ...
                          <div className="widget-subheading">AI Model Fit</div>
                      ...
                      <Col md="6">
                        <div className="card mb-3 bg-midnight-bloom widget-chart text-white card-border">
                          ...
                          <div className="widget-numbers">32.5M</div>
                          <div className="widget-subheading">
                            Number of Population Data used
                          </div>
                          <div className="widget-description text-white">
                      ...
                      <Col md="6">
                        <div className="card mb-3 bg-grow-early widget-chart text-white card-border">
                          ...
                          <div className="widget-subheading">
                            Highly Desirable Population
                          </div>
                          <div className="widget-description text-white">
                            <FontAwesomeIcon icon={faArrowRight} />
                            <span className="pl-1">22.1%</span>
                          </div>
                        </div>
                      </Col>
                      <Col md="6">
                        <div className="card mb-3 bg-love-kiss widget-chart card-border">
                          <div className="widget-chart-content text-white">
                            ...
                            <div className="widget-numbers">0.42</div>
                            <div className="widget-subheading">
                              Variance Score
                            </div>
                    ...
                    <div className="card mb-3 widget-chart">
                      <div className="widget-chart-content">
                        ...
                        <div className="widget-numbers">451k</div>
                        <div className="widget-subheading">
                          Active Users Online
                        </div>
                        <div className="widget-description">
                  ...
                  <Col md="12">
                    <Card className="main-card mb-3">
                      <div className="card-header">
                        Most recent personal data gathered (pre-anonymization)
                        {/* <div className="btn-actions-pane-right">
                        ...
                        <table className="align-middle mb-0 table table-borderless table-striped table-hover">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td className="text-center">Dallas</td>
                            ...
                            <tr>
                              ...
                              <td className="text-center">Seattle</td>
                              <td className="text-center">
                            ...
                            <tr>
                              ...
                              <td className="text-center">New York City</td>
                              <td className="text-center">
                                <div className="badge badge-danger">Killed</div>
                              </td>
                              <td className="text-center">
                                <button
                                  type="button"
                            ...
                            <tr>
                              ...
                              <td className="text-center">St.Louis</td>
                              <td className="text-center">
